...
ixNet setAttr $custom_view -caption "protocols-access-drilldown"
...
ixNet setMultiAttr $custom_view/layer23ProtocolStackFilter                       \
	...
	-numberOfResults        500                                                  \
	-protocolStackFilterId  [list [lindex $availableProtocolStackFilter 1]]
ixNet commit

puts "Configuring the sorting order"
ixNet setMultiAttr $custom_view/layer23ProtocolStackFilter                       \
	-sortAscending          true                                                 \
	-sortingStatistic       [lindex [ixNet getList $custom_view statistic] 0]
ixNet commit
...
puts "[ixNet help ::ixNet::OBJ-/statistics/view]"
puts " "
puts "ixNet help ::ixNet::OBJ-/statistics/view/layer23ProtocolStackFilter"
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23ProtocolStackFilter]"
puts " "
