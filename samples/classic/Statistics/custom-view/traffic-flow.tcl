...
ixNet setAttr $custom_view -caption "traffic-flow"
ixNet setAttr $custom_view -type layer23TrafficFlow
...
ixNet setAttr $custom_view/layer23TrafficFlowFilter -portFilterIds         $availablePortFilter
ixNet setAttr $custom_view/layer23TrafficFlowFilter -aggregatedAcrossPorts false
ixNet setAttr $custom_view/layer23TrafficFlowFilter -trafficItemFilterIds  $availableTrafficItemFilter
ixNet commit

puts "Configure the enumeration filter - Soring and Grouping Hierarchy"
foreach trackingFilter $availableTrackingFilter {
    set enumFilter [ixNet add  $custom_view/layer23TrafficFlowFilter enumerationFilter]
    ixNet setAttr $enumFilter -trackingFilterId $trackingFilter
    ixNet setAttr $enumFilter -sortDirection ascending
    ixNet commit
}
...
puts "[ixNet help ::ixNet::OBJ-/statistics/view]"
puts " "
puts "ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowFilter"
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowFilter]"
puts " "
puts "ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowFilter/enumerationFilter"
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowFilter/enumerationFilter]"
puts " "
