...
ixNet setAttr $custom_view -caption "traffic-flow-detective-dead-flows"
...
ixNet setAttr $custom_view/layer23TrafficFlowDetectiveFilter -flowFilterType        deadFlows
...
ixNet setAttr $statFilter -operator          isSmaller
ixNet setAttr $statFilter -value             5
ixNet commit

puts "Configure the liveFlows filter"
ixNet setAttr $custom_view/layer23TrafficFlowDetectiveFilter/deadFlowsFilter -numberOfResults    10
ixNet setAttr $custom_view/layer23TrafficFlowDetectiveFilter/deadFlowsFilter -sortingCondition   descending
ixNet commit
...
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowDetectiveFilter]"
puts " "
puts "ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowDetectiveFilter/deadFlowsFilter"
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23TrafficFlowDetectiveFilter/deadFlowsFilter]"
puts " "
