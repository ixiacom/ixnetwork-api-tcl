...
ixNet setAttr $custom_view -caption "protocols-access"
ixNet setAttr $custom_view -type layer23ProtocolAuthAccess
...
ixNet setAttr $custom_view/layer23ProtocolAuthAccessFilter -protocolFilterIds  [lindex $availableProtocolFilter 0]
ixNet commit

puts "Configure the port filter"
set availablePortFilter [ixNet getList $custom_view availablePortFilter]
ixNet setAttr $custom_view/layer23ProtocolAuthAccessFilter -portFilterIds [list [lindex $availablePortFilter 0]]
ixNet commit

puts "Enable only few stats columns to be disaplyed"
set statsList [ixNet getList $custom_view statistic]
foreach stat [lrange $statsList 0 5] {
...
puts "[ixNet help ::ixNet::OBJ-/statistics/view]"
puts " "
puts "ixNet help ::ixNet::OBJ-/statistics/view/layer23ProtocolAuthAccessFilter"
puts "[ixNet help ::ixNet::OBJ-/statistics/view/layer23ProtocolAuthAccessFilter]"
puts " "
