...
################################################################################
puts "Adding eCPRI REC layer on Ethernet"
set eCpriRec1  [ixNet add $ethernet1 "eCpriRec"]
ixNet commit
...
ixNet setA $eCpriRec1 -messageType "onewayDelayMeasurement"
ixNet commit
...
set eCpriRe1  [ixNet add $ethernet2 "eCpriRe"]
ixNet commit
...
################################################################################
puts "Creating Traffic from eCPRI REC to Ethernet"
