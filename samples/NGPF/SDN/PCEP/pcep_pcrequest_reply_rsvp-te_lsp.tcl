...
set responsePathTypeMv [ixNet getAttribute $pcReplyLspParameters1 -responsePathType]
...
set initialDelegation [ixNet getAttribute $rsvpp2p2 -initialDelegation]
ixNet add $initialDelegation "singleValue"
ixNet setMultiAttribute $initialDelegation/singleValue\
            -value "true"
ixNet commit

set lspOperativeModeMv [ixNet getAttribute $rsvpp2p2 -lspOperativeMode]
