...
ixNet commit
set lag1lacp [ixNet add $lag1eth "nglacp"]

# To add StaticLag as LAG protocol
# Command - set lag1static [ixNet add $lag1eth "ngstaticlag"]
...
ixNet commit
set lag2lacp [ixNet add $lag2eth "nglacp"]

# To add StaticLag as LAG protocol
# Command - set lag2static [ixNet add $lag2eth "ngstaticlag"]
...
ixNet exec lacpStopPDU $RedLAGlacp
...
ixNet exec lacpStartPDU $RedLAGlacp
after 90000
